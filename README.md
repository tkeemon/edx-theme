...
- Edit the lms.env.json file in the edx-platform directory of your edx machine and set both 'FEATURES.USE_CUSTOM_THEME' to true, and 'THEME_NAME' to your theme's name.
